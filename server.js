...
router.get("latestrun/:version",function(req,res){
    ...
    pool.getConnection(function(err,connection){
    var query=connection.query(`Select t.branchName,t.branchVersion,t.totalCases,t.totalPass,t.totalFail,t.type,t.createdON FROM 
        regression_run.TestRun as t where t.branchVersion=? order by createdON limit 5;`,[version],function(error,rows){
